...
import { useReplyAllEmailInSlider } from "../../../../../../../../common/Email/hooks/ReplyAll/useReplyAllEmailInSlider.js";

const ReplyAll = ({ email, constituent }) => {
  ...
  const [replyAllToEmail] = useReplyAllEmailInSlider({
    caseId: caseID,
    emailId: emailID,
    email,
    constituent,
